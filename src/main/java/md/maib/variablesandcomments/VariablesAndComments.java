package md.maib.variablesandcomments;

public class VariablesAndComments {
    public static void main(String[] args) {

        // Declare the primitive data type variable
        ...
        lowerLimitOfFloatDataType = -3.4028235E38f;
        upperLimitOfFloatDataType = 3.4028235E38f;
        lowerLimitOfDoubleDataType = -1.7976931348623157E308;
        upperLimitOfDoubleDataType = 1.7976931348623157E308;
